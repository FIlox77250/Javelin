...
public class MiniWebServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        httpServer.createContext("/", MiniWebServer::handleRequest);
        httpServer.createContext("/status", MiniWebServer::handleStatus);
        httpServer.createContext("/api/time", MiniWebServer::handleApiTime);
        ...
        if (ksFile.exists()) {
            ...
            httpsServer.createContext("/", MiniWebServer::handleRequest);
    ...
    private static void addDefaultHeaders(HttpExchange ex) {
        ex.getResponseHeaders().set("Server", "MiniJava/1.0");
